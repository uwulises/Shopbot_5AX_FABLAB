...
+ MattS	   2/18/2016  updated header, translated from X_par to Y_Par
+ MattS    5/6/2016   converted to mm
+ MattS	   6/1/2016   changed "IF %(25)=" check at begining to check for mm not inches
+================================================

POST_NAME = "Shopbot Indexer Y-Parallel TC (mm) - 2016(*.sbp)"
...
"'----------------------------------------------------------------"
"'SHOPBOT Y-PARALLEL INDEXER FILE"
"'GENERATED BY V-Carve or Aspire"
"'X-values are wrapped around Y axis and output as B"
"'Units= MM"
"'Minimum extent in Y = [YMIN] Minimum extent in Z = [ZMIN]"
"'Maximum extent in Y = [YMAX] Maximum extent in Z = [ZMAX]"
"'Length of material in Y = [YLENGTH]"
"'Circumferance = [XLENGTH]"
