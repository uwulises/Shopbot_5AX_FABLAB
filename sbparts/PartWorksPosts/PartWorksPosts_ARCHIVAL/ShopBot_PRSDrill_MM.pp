...
POST_NAME = "ShopBot PRS Drill MM (*.sbp)"
...
begin HEADER
 ...
 "MZ, [ZH]+&my_ZmmDrilloffset_T[T]	'Move Z to safe height to acivate Drill"
...
"J3,[X]+&my_XmmDrilloffset_T[T],[Y]+&my_YmmDrilloffset_T[T],[Z]+&my_ZmmDrilloffset_T[T]"
