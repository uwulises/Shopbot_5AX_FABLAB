...
POST_NAME = "ShopBot AirDrill MM(*.sbp)"
...
"J2,[X]-&my_XmmDrilloffset_T[T],[Y]-&my_YmmDrilloffset_T[T]"
...
"END"
 ...
 "END"
"PREVMODE:"
 "&my_XmmDrilloffset_T2=0			'These values must remain zero for the preview to display properly."    
 "&my_YmmDrilloffset_T2=0"     
 "&my_XmmDrilloffset_T3=0"	
 "&my_YmmDrilloffset_T3=0"	
 "RETURN"